---
title: "Possession and Telling Time"
weight: 13
bookToc: true
---

# Omistus ja Kellonajat - Possession and Telling Time ⏰

## Possession Structure (minulla on)

Finnish expresses possession using the structure **-lla/-llä + on** (literally "at me there is").
...
- Hänellä on kaksi lasta. (He/she has two children.)

## Telling Time (Mitä kello on?)
...
**Kello on [number]** = It's [number] o'clock
...
### Examples
- Kello on puoli seitsemän. (It's 6:30.)
- Tapaamme kuudelta. (We'll meet at six.)
